...
### 4. The full Transformer decoder layer
### 5. The complete Transformer stack
...
- Transformer decoder layer maintains input/output shapes
- The complete Transformer stack: the last dimension is equal to the vocabulary size
